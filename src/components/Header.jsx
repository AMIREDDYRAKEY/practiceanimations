    ...
    <header className="bg-gray-800 text-white shadow-lg fixed top-0 left-0 w-full z-50">
      <div className="max-w-6xl  px-6 py-4 flex justify-between items-center">
        ...
        <nav className="hidden lg:flex space-x-6">
          <Link to="/base" className="hover:text-pink-400 transition font-medium">
            Base
          </Link>
          <Link to="/toppings" className="hover:text-pink-400 transition font-medium">
            Toppings
          </Link>
          <Link to="/order" className="hover:text-pink-400 transition font-medium">
            Order
          </Link>
        </nav>
